...
const TutorialOverlay: React.FC<TutorialOverlayProps> = ({ step, onNext }) => {
  ...
  return (
    <div className="absolute inset-0 z-[90] pointer-events-none overflow-hidden">
      ...
      {step === 2 && (
        <div className="absolute top-[30%] left-1/2 -translate-x-1/2 flex flex-col items-center animate-bounce">
           <MousePointerClick className="text-white fill-white/20 drop-shadow-lg mb-2" size={48} />
      ...
      {step === 4 && (
        <div className="absolute top-[30%] left-1/2 -translate-x-1/2 flex flex-col items-center animate-ping-slow">
           <MousePointerClick className="text-red-500 fill-red-500/20 drop-shadow-lg mb-2 scale-125" size={48} />
      ...
      {step === 5 && (
        <div className="absolute bottom-[20%] left-1/2 -translate-x-1/2 flex flex-col items-center animate-bounce">
           ...
           <MousePointerClick className="text-white fill-white/20 drop-shadow-lg" size={48} />
        </div>
      )}
    </div>
  );
